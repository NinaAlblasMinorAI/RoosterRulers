...
if __name__ == "__main__":
    ...
    main(args.algorithm, args.nr_runs, args.nr_repeats, args.nr_outer_repeats, args.nr_inner_repeats, args.verbosity)
=======
...
visualize_schedule(test_schedule, f"output_data/random_schedule.html")
# test_schedule.get_dataframe().to_csv("test.csv")
