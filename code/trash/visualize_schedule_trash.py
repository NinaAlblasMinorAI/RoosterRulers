...
from bokeh.models import ColumnDataSource, Grid, LinearAxis, Plot, Rect, Paragraph, Text, HoverTool, LinearColorMapper
...
def visualize_schedule_trash(schedule_obj, output_file_path):
